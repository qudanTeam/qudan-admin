export default {
  ...
  'menu.home': '首页',
  'menu.agency_manager': '代理管理',
  'menu.agency_manager.list': '代理列表',
  'menu.agency_manager.settings': '代理参数设置',
  ...
  'menu.content_manager.message': '消息管理',
  'menu.content_manager.resource': '素材管理',
  'menu.goods_manager': '商品管理',
  'menu.goods_manager.add': '添加商品',
  'menu.goods_manager.add.common': '添加商品 - 通用信息',
  'menu.goods_manager.add.details': '添加商品 - 商品详情',
  'menu.goods_manager.add.result': '添加商品 - 结果页',
  'menu.goods_manager.list': '商品列表',
  'menu.goods_manager.settings': '配置',
  'menu.goods_manager.settings.bank_cark_category': '银行卡分类',
  'menu.goods_manager.settings.loan_category': '贷款分类',
  'menu.goods_manager.settings.settle': '商品奖金结算',
  'menu.member_manager': '用户管理',
  'menu.member_manager.advertisers': '广告主',
  'menu.member_manager.settings': 'VIP 参数设置 ',
  'menu.member_manager.list': '用户列表',
  'menu.order_manager': '订单管理',
  'menu.order_manager.apply': '产品申请列表',
  'menu.order_manager.list': '订单列表',
  'menu.settings': '系统设置',
  'menu.settings.account': '账户管理',
  'menu.store_manager': '店铺管理',
  'menu.store_manager.list': '店铺列表',
  ...
  'app.login.message-invalid-credentials': '账户或密码错误（ironman/ironic）',
